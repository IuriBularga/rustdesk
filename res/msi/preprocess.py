...
def make_parser():
    ...
    parser.add_argument(
        "--app-name", type=str, default="TradingMD Remote", help="The app name."
    )
    parser.add_argument(
...
def update_license_file(app_name):
    ...
    # TradingMD: do NOT rewrite the licensor ("Purslane Tech Pte. Ltd") — the
    # original copyright notice must stay in the installer EULA.
